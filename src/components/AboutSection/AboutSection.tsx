  ...
  return (
    ...
    >
      <div className="relative z-10 flex flex-col items-center gap-4">
        <Paragraph text={mainSections.aboutSection.text} />
        <button className="relative mt-8 flex h-8 w-48 flex-1 items-center self-center">
          ...
          <div className="static z-10 w-full -translate-y-1 translate-x-1 border border-stone-800 bg-stone-100 transition-all duration-700 ease-in-out hover:-translate-y-1 hover:translate-x-1 sm:translate-x-0 sm:translate-y-0">
            CURRICULUM VITAE
          </div>
        </button>
      </div>
      {/* <div className="relative z-10 flex flex-col gap-4 text-justify sm:w-80">
          ...
          <p>
            ...
            made the decision to return to programming and web design, spending
            2022 / 2023 updating my front end design and development skillset.
            These skills buld upon previous freelance experience and being
            privileged to work as the media Coordinator for the internationally
            recognized design studio molo in Vancouver.
          </p>
          <p>
            ...
            work I put my focus to, I have found that the core to my approach is
            accute attention to detail, dedication to excellence, and supporting
